...
Brief is a local-first CLI for saving development context per git branch. It helps you capture todos, notes, commands, and decisions while you work — then instantly restore that context when you return.
